...
<title>Kontraktor & Proyek — Sistem Siap Pakai | Mora Bangun Solutions</title>
...
<header class="hero">
  <div class="container hero-grid">
    <div>
      <span class="eyebrow" data-i18n="eyebrowX">🏗️ Kontraktor · Developer · Proyek</span>
      <h1 data-i18n="h1">Owner Tanya Progress Tiap Hari, Termin Cair Tersendat.<br><span class="hl">Transparansi yang Mencairkan Pembayaran.</span></h1>
      <p class="sub" data-i18n="hsub">Portal owner proyek: progress per pekerjaan, foto lapangan harian, termin & RAB vs realisasi — owner meninjau dan menyetujui dari HP.</p>
      <div class="hero-ctas">
        <a class="btn btn-primary" href="#demo" data-i18n="ctaDemo">▶ Lihat Demo Langsung</a>
        <a class="btn btn-wa" data-wa data-pkg="Kontraktor & Proyek" data-pos="hero" href="https://wa.me/6281399997132" target="_blank" rel="noopener" data-i18n="ctaWa">💬 Konsultasi Gratis</a>
      </div>
      <div class="trust"><div><b data-i18n="t0b">Live</b><span data-i18n="t0">Portal Forwarder — fondasi teknis sama</span></div><div><b data-i18n="t1b">RAB vs realisasi</b><span data-i18n="t1">terpantau per item</span></div><div><b data-i18n="t2b">Approval</b><span data-i18n="t2">owner dari HP · audit log</span></div></div>
    </div>
    <div class="hero-visual">
      <img src="/images/solusi/kontraktor-hero.webp" alt="Kontraktor & Proyek" width="1448" height="1086" loading="eager" fetchpriority="high" style="width:100%;height:auto;display:block;border-radius:10px">
    </div>
  </div>
</header>
...
<section>
  <div class="container center">
    ...
    <div class="cards3" style="text-align:left">
      <div class="pain-card">
        <div class="ico">📞</div>
        <h3 data-i18n="kontraktor_pain_0_h">Owner Tanya Progress Tiap Hari</h3>
        <p data-i18n="kontraktor_pain_0_p">Tanpa laporan berkala, owner menelepon/WA berulang menanyakan sudah sampai mana pekerjaan.</p>
        <div class="fix" data-i18n="kontraktor_pain_0_f">✓ Progress terlihat jelas dari HP owner kapan saja</div>
      </div>
      <div class="pain-card">
        <div class="ico">💰</div>
        <h3 data-i18n="kontraktor_pain_1_h">Termin Cair Lambat</h3>
        <p data-i18n="kontraktor_pain_1_p">Owner ragu menyetujui termin karena tidak yakin progress sesuai klaim — pembayaran tertunda berminggu-minggu.</p>
        <div class="fix" data-i18n="kontraktor_pain_1_f">✓ Foto & data progress jadi bukti, approval dari HP</div>
      </div>
      <div class="pain-card">
        <div class="ico">📊</div>
        <h3 data-i18n="kontraktor_pain_2_h">RAB vs Realisasi Tak Terpantau</h3>
        <p data-i18n="kontraktor_pain_2_p">Biaya aktual baru diketahui menyimpang dari RAB setelah proyek jauh berjalan — sudah terlambat dikoreksi.</p>
        <div class="fix" data-i18n="kontraktor_pain_2_f">✓ Realisasi biaya per item terpantau sejak dini</div>
      </div>
    </div>
  </div>
</section>
...
<section id="demo" style="padding-top:40px">
  <div class="container center">
    ...
    <div id="demo-kontraktor">
<div class="demo-wrap" id="dw-kon">
      <div class="demo-toolbar">
        <div>
          <span class="lbl">White-label: warna perusahaan Anda</span>
          <div class="swatches">
            <button class="swatch active" style="background:#f97316" onclick="setSw('kon','#f97316',this)" aria-label="oranye"></button>
            <button class="swatch" style="background:#0284c7" onclick="setSw('kon','#0284c7',this)" aria-label="biru"></button>
            <button class="swatch" style="background:#dc2626" onclick="setSw('kon','#dc2626',this)" aria-label="merah"></button>
            <button class="swatch" style="background:#65a30d" onclick="setSw('kon','#65a30d',this)" aria-label="hijau"></button>
          </div>
        </div>
        <div>
          <span class="lbl">Nama perusahaan Anda</span><br>
          <input class="tenant-input" value="CV Karya Beton" oninput="setTenant('kon',this.value)">
          <div class="wa-hint">↳ nama ini otomatis masuk ke chat WA Anda</div>
        </div>
      </div>
      <div class="demo-app">
        <aside class="demo-side">
          <div class="tenant-badge"><div class="tenant-avatar" id="av-kon">KB</div><div><b class="tn-kon">CV Karya Beton</b><small>Portal Owner Proyek</small></div></div>
          <button class="side-item active" onclick="go('kon','dash',this)">📊 Ringkasan</button>
          <button class="side-item" onclick="go('kon','progress',this)">📈 Progress</button>
          <button class="side-item" onclick="go('kon','foto',this)">📷 Foto Lapangan</button>
          <button class="side-item" onclick="go('kon','termin',this)">💰 Termin & RAB <span class="bdg">1</span></button>
        </aside>
        <main class="demo-main">
          <div class="scr on" id="kon-dash">
            ...
            <div class="dtable">
              ...
              <div class="ann"><div><b>Pengecoran plat lantai 2 selesai</b><small>K1–K8 · mutu beton K-300 · slump test OK</small></div><span class="pill pill-g">Selesai</span></div>
              <div class="ann"><div><b>Pemasangan kusen aluminium lantai 1</b><small>progres 60% · target selesai Sabtu</small></div><span class="pill pill-b">Berjalan</span></div>
              <div class="ann"><div><b>Material besi 10mm tiba di lokasi</b><small>4 ton · cek surat jalan SJ-0281</small></div><span class="pill pill-g">Diterima</span></div>
            </div>
          </div>
          <div class="scr" id="kon-progress">
            <h4>Progress per Pekerjaan</h4>
            <div class="ddate">Bobot tertimbang sesuai RAB · update harian oleh pelaksana</div>
            <div class="dtable"><div class="tt">Item Pekerjaan Utama</div>
              <div class="scrollx"><table>
                <thead><tr><th>Pekerjaan</th><th>Bobot</th><th>Progress</th><th>Status</th></tr></thead>
                <tbody>
                  <tr><td>Struktur (pondasi–plat)</td><td>40%</td><td>100%</td><td><span class="pill pill-g">Selesai</span></td></tr>
                  <tr><td>Arsitektur (dinding, kusen)</td><td>30%</td><td>55%</td><td><span class="pill pill-b">Berjalan</span></td></tr>
                  <tr><td>MEP (listrik, plumbing)</td><td>20%</td><td>30%</td><td><span class="pill pill-a">Perlu percepatan</span></td></tr>
                  <tr><td>Finishing & landscape</td><td>10%</td><td>0%</td><td><span class="pill pill-b">Belum mulai</span></td></tr>
                </tbody>
              </table></div>
            </div>
          </div>
          <div class="scr" id="kon-foto">
            <h4>Foto Lapangan</h4>
          ...
          <div class="scr" id="kon-termin">
            <h4>Termin & RAB</h4>
            <div class="ddate">Termin cair setelah progress terverifikasi — semua approval tercatat</div>
            <div class="dtable"><div class="tt">Jadwal Termin</div>
              <div class="scrollx"><table>
                <thead><tr><th>Termin</th><th>Nilai</th><th>Syarat</th><th>Status</th></tr></thead>
                <tbody>
...
<section id="fitur" style="background:var(--surface);border-top:1px solid var(--border);border-bottom:1px solid var(--border)">
  <div class="container center">
    ...
    <div class="feat-grid" style="text-align:left">
      <div class="feat">
        <div class="ico">🎨</div>
        <h3 data-i18n="kontraktor_feat_0_h">White-Label Penuh</h3>
        <p data-i18n="kontraktor_feat_0_p">Logo, warna, dan subdomain milik Anda sendiri. Pengguna melihat brand Anda, bukan kami.</p>
        
      </div>
      <div class="feat">
        <div class="ico">📈</div>
        <h3 data-i18n="kontraktor_feat_1_h">Progress per Pekerjaan</h3>
        <p data-i18n="kontraktor_feat_1_p">Bobot tertimbang sesuai RAB, update harian oleh pelaksana lapangan.</p>
        
      </div>
      <div class="feat">
        <div class="ico">📷</div>
        <h3 data-i18n="kontraktor_feat_2_h">Foto Lapangan Ber-Stempel</h3>
        <p data-i18n="kontraktor_feat_2_p">Dokumentasi harian dengan waktu & lokasi — jadi bukti sah untuk termin.</p>
        
      </div>
      <div class="feat">
        <div class="ico">💰</div>
        <h3 data-i18n="kontraktor_feat_3_h">Termin & RAB vs Realisasi</h3>
        <p data-i18n="kontraktor_feat_3_p">Owner melihat langsung realisasi biaya per item, bukan laporan akhir bulan.</p>
        
      </div>
      <div class="feat">
        <div class="ico">✍️</div>
        <h3 data-i18n="kontraktor_feat_4_h">Approval Owner dari HP</h3>
        <p data-i18n="kontraktor_feat_4_p">Owner menyetujui termin langsung dari portal — tercatat dengan audit log.</p>
        
      </div>
      <div class="feat">
        <div class="ico">💬</div>
        <h3 data-i18n="kontraktor_feat_5_h">Notifikasi WhatsApp Otomatis</h3>
        <p data-i18n="kontraktor_feat_5_p">Status berubah → pengguna dapat WA otomatis. Tanpa staf kirim manual satu-satu.</p>
        
      </div>
      <div class="feat">
        <div class="ico">👥</div>
        <h3 data-i18n="kontraktor_feat_6_h">Multi-User & Role</h3>
        <p data-i18n="kontraktor_feat_6_p">Admin, staf operasional, keuangan — login terpisah per peran. Audit log lengkap.</p>
        
      </div>
      <div class="feat">
        <div class="ico">🌐</div>
        <h3 data-i18n="kontraktor_feat_7_h">Multi-Bahasa (ID/EN)</h3>
        <p data-i18n="kontraktor_feat_7_p">Portal tersedia dwibahasa — siap dipakai pengguna asing/mitra luar negeri Anda.</p>
        
      </div>
      <div class="feat">
        <div class="ico">📋</div>
        <h3 data-i18n="kontraktor_feat_8_h">Multi-Proyek</h3>
        <p data-i18n="kontraktor_feat_8_p">Kelola beberapa proyek berjalan sekaligus dari satu dashboard.</p>
        <span class="tag">Add-on</span>
      </div>
      <div class="feat">
        <div class="ico">🤖</div>
        <h3 data-i18n="kontraktor_feat_9_h">Chatbot AI</h3>
        <p data-i18n="kontraktor_feat_9_p">Pengguna bertanya lewat chat → bot jawab dari data portal, 24 jam.</p>
        <span class="tag">Add-on</span>
      </div>
    </div>
  </div>
...
<section class="proof">
  <div class="container proof-grid">
    <div>
      ...
      <p class="sub" data-i18n="kontraktor_prfSub">Bukan produk coba-coba. Fondasi teknisnya sudah live dan dipakai setiap hari.</p>
      <div class="proof-stats"><div class="pstat"><b data-i18n="kontraktor_ps_0_b">Live</b><small data-i18n="kontraktor_ps_0_s">Portal Forwarder — fondasi teknis sama</small></div><div class="pstat"><b data-i18n="kontraktor_ps_1_b">Audit log</b><small data-i18n="kontraktor_ps_1_s">Setiap approval tercatat</small></div><div class="pstat"><b data-i18n="kontraktor_ps_2_b">14 hari</b><small data-i18n="kontraktor_ps_2_s">Rata-rata waktu tayang</small></div><div class="pstat"><b data-i18n="kontraktor_ps_3_b">Foto ber-stempel</b><small data-i18n="kontraktor_ps_3_s">Bukti sah untuk klaim termin</small></div></div>
    </div>
    <div class="quote">
      <p data-i18n="kontraktor_qt">"Prinsip yang sama dengan Portal Forwarder kami yang live setiap hari — transparansi status ke pihak eksternal — kami terapkan di sini: owner melihat progress apa adanya, bukan laporan yang disaring."</p>
      <div class="who">
        <div class="av">MB</div>
        <div><b data-i18n="kontraktor_qtWho">Tim Mora Bangun Solutions</b><small data-i18n="kontraktor_qtCo">Software house untuk konstruksi & proyek, Medan</small></div>
      </div>
    </div>
  </div>
</section>
...
<section id="faq">
  <div class="container center">
    ...
    <div class="faq" style="text-align:left">
      <details><summary data-i18n="kontraktor_fq0">Data operasional kami sudah di Excel. Harus input ulang?</summary><p data-i18n="kontraktor_fa0">Tidak. Paket Professional termasuk import data dari Excel existing. Tim Anda cukup update status — atau kami integrasikan dengan sistem yang sudah jalan.</p></details>
      <details><summary data-i18n="kontraktor_fq1">Apakah pengguna kami harus bayar atau install aplikasi?</summary><p data-i18n="kontraktor_fa1">Tidak. Cukup buka portal dari browser HP/laptop, login, selesai. Tanpa install, tanpa biaya untuk mereka.</p></details>
      <details><summary data-i18n="kontraktor_fq2">Bagaimana keamanan data kami?</summary><p data-i18n="kontraktor_fa2">Setiap akun hanya melihat datanya sendiri (isolasi per akun). Server di Indonesia, backup harian, dan audit log semua aktivitas.</p></details>
      <details><summary data-i18n="kontraktor_fq3">14 hari tayang itu benar realistis?</summary><p data-i18n="kontraktor_fa3">Ya, karena kami tidak membangun dari nol — fondasinya sudah jadi dan teruji (lihat Portal Forwarder yang live). Yang kami kerjakan: branding Anda, subdomain, import data, dan training.</p></details>
      <details><summary data-i18n="kontraktor_fq4">Siapa yang input progress harian?</summary><p data-i18n="kontraktor_fa4">Pelaksana/mandor lapangan Anda — dari HP, cukup foto + centang pekerjaan selesai. Tidak perlu laptop di lokasi.</p></details>
      <details><summary data-i18n="kontraktor_fq5">Owner bisa menolak approval termin?</summary><p data-i18n="kontraktor_fa5">Bisa, dengan catatan alasan penolakan — tercatat di riwayat sehingga tidak ada dispute di kemudian hari.</p></details>
    </div>
  </div>
</section>

<x-related-articles vertical="kontraktor" />
...
<section class="final">
  <div class="container">
    ...
    <a class="btn btn-wa" style="font-size:1.05rem;padding:16px 36px" data-wa data-pkg="Kontraktor & Proyek" data-pos="final" href="https://wa.me/6281399997132" target="_blank" rel="noopener" data-i18n="finCta">💬 Jadwalkan Demo via WhatsApp</a>
...
<a class="fab-wa" data-wa data-pkg="Kontraktor & Proyek" data-pos="fab" href="https://wa.me/6281399997132" target="_blank" rel="noopener" aria-label="WhatsApp">💬</a>
...
<script>
  ...
  var EN = {
    ...
    'crossBlog': 'Blog',
    'eyebrowX': '🏗️ Contractors · Developers · Projects',
    'h1': 'The Owner Asks for Progress Daily, Payments Stall.<br><span class="hl">Transparency That Gets You Paid Faster.</span>',
    'hsub': 'Project owner portal: progress per work item, daily site photos, payment terms & budget vs actuals — owners review and approve from their phone.',
    'ctaDemo': '&#9654; See the Live Demo',
    'ctaWa': '&#128172; Free Consultation',
    't0b': 'Live',
    't0': 'Portal Forwarder — same technical foundation',
    't1b': 'Budget vs actuals',
    't1': 'tracked per line item',
    't2b': 'Approval',
    't2': 'owner from phone · audit log',
    'painEye': 'The Problems You Face Every Day',
    'painH2': 'You Don\'t Lose Because of Price.<br>You Lose Because of Manual Chaos.',
    'kontraktor_pain_0_h': 'Owner Asks About Progress Daily',
    'kontraktor_pain_0_p': 'Without regular reports, the owner calls/WA repeatedly asking how far the work has progressed.',
    'kontraktor_pain_0_f': '✓ Progress clearly visible from the owner\'s phone anytime',
    'kontraktor_pain_1_h': 'Payment Terms Are Slow to Clear',
    'kontraktor_pain_1_p': 'The owner hesitates to approve payment because they\'re unsure progress matches claims — payment delayed for weeks.',
    'kontraktor_pain_1_f': '✓ Photos & progress data serve as proof, approval from phone',
    'kontraktor_pain_2_h': 'Budget vs Actuals Not Tracked',
    ...
    'kontraktor_feat_0_h': 'Full White-Label',
    'kontraktor_feat_0_p': 'Your own logo, colors and subdomain. Users see your brand, not ours.',
    'kontraktor_feat_1_h': 'Progress per Work Item',
    'kontraktor_feat_1_p': 'Weighted per RAB, updated daily by the field team.',
    'kontraktor_feat_2_h': 'Timestamped Site Photos',
    'kontraktor_feat_2_p': 'Daily documentation with time & location — valid proof for payment terms.',
    'kontraktor_feat_3_h': 'Payment Terms & Budget vs Actuals',
    'kontraktor_feat_3_p': 'Owners see cost realization per item directly, not an end-of-month report.',
    'kontraktor_feat_4_h': 'Owner Approval From Phone',
    'kontraktor_feat_4_p': 'Owners approve payment terms directly from the portal — recorded with an audit log.',
    'kontraktor_feat_5_h': 'Automatic WhatsApp Notifications',
    'kontraktor_feat_5_p': 'Status changes → users get WA automatically. No manual one-by-one messaging.',
    'kontraktor_feat_6_h': 'Multi-User & Roles',
    'kontraktor_feat_6_p': 'Admin, operations, finance — separate logins per role. Full audit log.',
    'kontraktor_feat_7_h': 'Multi-Language (ID/EN)',
    'kontraktor_feat_7_p': 'The portal is bilingual — ready for your foreign users or overseas partners.',
    'kontraktor_feat_8_h': 'Multi-Project',
    'kontraktor_feat_8_p': 'Manage multiple running projects at once from one dashboard.',
    'kontraktor_feat_9_h': 'AI Chatbot',
    'kontraktor_feat_9_p': 'Users ask via chat → the bot answers from portal data, 24/7.',
    'prEye': 'Investment',
    ...
    'kontraktor_pr_Starter_i2': 'White-label logo & colors',
    'kontraktor_pr_Starter_i3': 'Unlimited owner logins',
    'kontraktor_pr_Starter_n0': 'Payment terms & budget vs actuals',
    'kontraktor_pr_Starter_n1': 'Recorded owner approval',
    'kontraktor_pr_Starter_cta': 'Choose Starter',
    'kontraktor_pr_Professional_for': '+ payment terms & budget, owner approval, WA, multi-project',
    'kontraktor_pr_Professional_i0': '<b style="color:var(--text)">Everything in Starter</b>, plus:',
    'kontraktor_pr_Professional_i1': 'Payment terms & budget vs actuals',
    'kontraktor_pr_Professional_i2': 'Owner approval from phone',
    'kontraktor_pr_Professional_i3': 'Automatic WA notifications',
    'kontraktor_pr_Professional_i4': 'Multi-project',
    ...
    'kontraktor_pr_Enterprise_i3': 'Dedicated server + SLA',
    'kontraktor_pr_Enterprise_i4': 'Custom modules as needed',
    'kontraktor_pr_Enterprise_cta': 'Discuss Your Needs',
    'prfEye': 'Proof, Not Promises',
    'prfH2': 'Built by Practitioners Who Run Real Systems',
    'kontraktor_prfSub': 'Not an experiment. The technical foundation is already live and used every day.',
    'kontraktor_ps_0_b': 'Live',
    'kontraktor_ps_0_s': 'Portal Forwarder — same technical foundation',
    'kontraktor_ps_1_b': 'Audit log',
    'kontraktor_ps_1_s': 'Every approval is recorded',
    'kontraktor_ps_2_b': '14 days',
    'kontraktor_ps_2_s': 'Average time to go live',
    'kontraktor_ps_3_b': 'Timestamped photos',
    'kontraktor_ps_3_s': 'Valid proof for payment claims',
    'kontraktor_qt': '"The same principle behind our Portal Forwarder, live every day — transparent status to external parties — applies here: owners see progress as it is, not a filtered report."',
    'kontraktor_qtWho': 'Mora Bangun Solutions Team',
    'kontraktor_qtCo': 'Software house for construction & projects, Medan',
    'faqEye': 'Common Questions',
    'faqH2': 'What Owners Usually Ask',
    'kontraktor_fq0': 'Our operational data is already in Excel. Do we re-enter everything?',
    'kontraktor_fa0': 'No. The Professional plan includes importing your existing Excel data. Your team just updates statuses — or we integrate with the system you already run.',
    'kontraktor_fq1': 'Do our users have to pay or install an app?',
    'kontraktor_fa1': 'No. They just open the portal in any browser, log in, done. No install, no cost for them.',
    'kontraktor_fq2': 'How is our data secured?',
    'kontraktor_fa2': 'Each account only sees its own data (per-account isolation). Servers in Indonesia, daily backups, and full audit logs.',
    'kontraktor_fq3': 'Is 14 days to go live realistic?',
    'kontraktor_fa3': 'Yes — we\'re not building from scratch. The foundation is already finished and battle-tested (see our live Portal Forwarder). We handle your branding, subdomain, data import and training.',
    'kontraktor_fq4': 'Who enters daily progress?',
    'kontraktor_fa4': 'Your site supervisor/foreman — from their phone, just photo + check off completed work. No laptop needed on-site.',
    'kontraktor_fq5': 'Can the owner reject a payment term approval?',
    'kontraktor_fa5': 'Yes, with a reason for rejection — recorded in history so there\'s no dispute later.',
    'finEye': 'Next Step',
