  ...
  <div class="container">
    <div class="foot-grid">
      <div class="foot-brand">
        ...
        <p class="foot-desc">Partner transformasi digital berbasis AI dari Medan. Spesialis ERP, CRM, Corporate Portal &amp; Workflow Automation untuk Indonesia.</p>
      ...
      <div class="foot-col">
        <h4>Layanan</h4>
        <ul>
          <li><a href="https://morabangun.com/#services">Sistem ERP</a></li>
          <li><a href="https://morabangun.com/#services">CRM</a></li>
          <li><a href="https://morabangun.com/#services">Corporate Portal</a></li>
          <li><a href="https://morabangun.com/#services">AI Workflow</a></li>
          <li><a href="https://morabangun.com/#services">Chatbot AI</a></li>
          <li><a href="https://morabangun.com/#services">Custom Development</a></li>
        </ul>
      </div>
      <div class="foot-col">
        <h4>Perusahaan</h4>
        <ul>
          <li><a href="https://morabangun.com/harga">Harga</a></li>
          <li><a href="/solusi">Solusi Industri</a></li>
          <li><a href="https://morabangun.com/#portfolio">Portfolio</a></li>
          <li><a href="https://morabangun.com/#tech">Teknologi</a></li>
          <li><a href="https://morabangun.com/#testimonials">Testimoni</a></li>
          <li><a href="https://morabangun.com/#contact">Kontak</a></li>
        </ul>
      </div>
      <div class="foot-col foot-contact">
        ...
        <ul class="foot-contact-list">
          ...
          <li class="foot-addr"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg> <span>Medan, Sumatera Utara,<br>Indonesia 20111</span></li>
        </ul>
      </div>
    </div>
    <div class="foot-bottom">
      <p>© 2026 Mora Bangun Solutions · morabangun.com — Spesialis ERP &amp; Automation Pabrik Kelapa Sawit, Medan, Indonesia</p>
      <div class="foot-badges">
        <span>🔒 SSL Secured</span><span class="foot-dot">·</span>
        <span>● Production Ready</span><span class="foot-dot">·</span>
