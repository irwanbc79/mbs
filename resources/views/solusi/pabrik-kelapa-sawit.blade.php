...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .logo-mark{width:34px;height:34px;flex-shrink:0;filter:drop-shadow(0 0 6px var(--accent-soft))}
  ...
  .hero::before{content:'';position:absolute;top:-200px;left:50%;transform:translateX(-50%);width:900px;height:600px;background:radial-gradient(ellipse,rgba(16,185,129,.14),transparent 65%);pointer-events:none}
  .hero-grid{display:grid;grid-template-columns:1.05fr .95fr;gap:56px;align-items:center;position:relative}
  @media(max-width:920px){.hero-grid{grid-template-columns:1fr}}
  .hero h1 .hl{background:linear-gradient(90deg,var(--accent),#34d399);-webkit-background-clip:text;background-clip:text;color:transparent}
  ...
  .pain-card .ico{font-size:1.8rem;margin-bottom:14px}
  ...
  .demo-wrap{background:var(--surface);border:1px solid var(--border);border-radius:20px;overflow:hidden;margin-top:44px;box-shadow:0 40px 100px rgba(0,0,0,.5)}
  .demo-head{padding:18px 24px;background:var(--card);border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px}
  .demo-body{padding:28px;background:var(--bg)}
  .kpis{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-bottom:24px}
  @media(max-width:820px){.kpis{grid-template-columns:repeat(2,1fr)}}
  .kpi{background:var(--card);border:1px solid var(--border);border-radius:14px;padding:16px}
  .kpi small{font-size:.72rem;color:var(--dim);text-transform:uppercase;letter-spacing:.05em;font-weight:700}
  .kpi b{display:block;font-size:1.4rem;margin:4px 0 2px;color:var(--text)}
  .kpi span{font-size:.75rem;font-weight:600}
  ...
  .feat{background:var(--card);border:1px solid var(--border);border-radius:16px;padding:26px;transition:.2s}
  .feat:hover{border-color:var(--accent);transform:translateY(-3px)}
  .feat .ico{width:46px;height:46px;border-radius:12px;background:var(--accent-soft);display:grid;place-items:center;font-size:1.3rem;margin-bottom:16px}
  .feat h3{font-size:1.05rem;margin-bottom:8px}
  .feat p{font-size:.9rem;color:var(--muted)}
  .roi-box{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:32px;margin-top:44px;position:relative;overflow:hidden}
  ...
  .badge-pop{position:absolute;top:-13px;left:50%;transform:translateX(-50%);background:var(--accent);color:#041a12;font-size:.72rem;font-weight:800;padding:5px 16px;border-radius:999px;letter-spacing:.04em}
  .price h3{font-size:1.15rem}
  .amount{font-size:2.1rem;font-weight:800;margin:12px 0 4px}
  .monthly{font-size:.88rem;color:var(--muted);margin-bottom:22px}
  .price ul{list-style:none;margin-bottom:26px;flex:1}
  .price li{padding:8px 0;font-size:.9rem;color:var(--muted);display:flex;gap:10px}
...
<nav>
  <div class="container nav-inner">
    ...
    <div class="nav-links">
      <a href="https://morabangun.com">Beranda</a>
      <a href="/solusi">Semua Solusi</a>
      <span class="nav-sep"></span>
      <a href="https://morabangun.com/#portfolio">Portfolio</a>
      <a href="https://morabangun.com/harga">Harga</a>
      <a href="https://morabangun.com/#contact">Kontak</a>
    </div>
    <div class="nav-right">
      <a class="btn btn-primary" style="padding:10px 20px;font-size:.9rem" href="#harga">Lihat Paket PKS ↓</a>
    </div>
  </div>
</nav>
...
<div class="hero">
  <div class="container">
    <div class="hero-grid">
      <div>
        <span class="eyebrow">🌴 SOFTWARE ERP &amp; AUTOMATION PABRIK KELAPA SAWIT (PKS)</span>
        <h1>Digitalisasi PKS: <span class="hl">Timbangan IoT, Sortasi TBS &amp; Rendemen Real-Time</span></h1>
        <p class="sub">Hilangkan kebocoran tonase timbang, hitung OER &amp; KER per shift secara otomatis, serta penuhi kepatuhan EUDR &amp; ISPO dalam satu portal cloud modern.</p>
        <div style="margin-top:28px;display:flex;gap:14px;flex-wrap:wrap">
          <a href="https://wa.me/6281399997132?text=Halo%20MBS%2C%20saya%20tertarik%20Demo%20Sistem%20Pabrik%20Kelapa%20Sawit%20(PKS)" target="_blank" class="btn btn-primary">💬 Konsultasi &amp; Demo PKS</a>
...
<section style="background:var(--surface);border-top:1px solid var(--border);border-bottom:1px solid var(--border)">
  <div class="container">
    <div class="center">
      <span class="eyebrow">TANTANGAN OPERASIONAL PKS</span>
...
<section id="fitur">
  <div class="container">
    <div class="center">
      <span class="eyebrow">MODUL FITUR LENGKAP PKS</span>
      <h2>Satu Sistem Mengelola Seluruh Alur Operasional Pabrik</h2>
      <p class="sub">Dari truk TBS memasuki pintu gerbang pabrik hingga pengiriman tangki CPO ke pelabuhan.</p>
    </div>

    <div class="feat-grid">
      <div class="feat">
        <div class="ico">⚖️</div>
        <h3>1. IoT Digital Weighbridge &amp; E-Karcis</h3>
        <p>Integrasi langsung ke indikator timbangan (Avery, Rice Lake, Toledo). Cetak E-Karcis barcode otomatis &amp; terkirim ke WA supir/supplier.</p>
      </div>
      <div class="feat">
        <div class="ico">🔍</div>
        <h3>2. Digital Sortasi &amp; Penalti TBS</h3>
        <p>Input persentase buah mentah, lewat matang, busuk, &amp; potongan air/sampah. Otomatis memotong nominal pembayaran SPB supplier.</p>
      </div>
      <div class="feat">
        <div class="ico">📊</div>
        <h3>3. Real-Time OER &amp; KER Rendemen</h3>
        <p>Monitoring rasio ekstraksi minyak kelapa sawit (OER) &amp; inti sawit (KER) per shift kerja &amp; per kelompok kebun penyuplai.</p>
      </div>
      <div class="feat">
        <div class="ico">🚛</div>
        <h3>4. Dispatch CPO, PK &amp; Surat Jalan</h3>
        <p>Manajemen Kontrak Penjualan, Kuota DO (Delivery Order), Segel Truk Tangki CPO, &amp; Cetak Surat Jalan digital terlindungi QR Code.</p>
      </div>
      <div class="feat">
        <div class="ico">🗺️</div>
        <h3>5. EUDR &amp; ISPO Traceability</h3>
        <p>Pemetaan polygon lokasi kebun asal TBS (Kebun Inti, Plasma, Swadaya) untuk memenuhi standar audit ekspor CPO Uni Eropa.</p>
      </div>
      <div class="feat">
        <div class="ico">📲</div>
        <h3>6. Portal Supplier &amp; Koperasi TBS</h3>
        <p>Supplier &amp; Koperasi Mitra dapat mengecek riwayat tonase, rekap potongan sortasi, &amp; rincian pembayaran langsung dari HP.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="harga">
  <div class="container">
    <div class="center">
      <span class="eyebrow">PAKET LENGKAP PKS</span>
      <h2>Pilihan Paket Sistem ERP &amp; Automation PKS</h2>
      <p class="sub">Pilih paket sesuai skala kapasitas olah dan kebutuhan integrasi pabrik kelapa sawit Anda.</p>
    </div>

    <div class="price-grid">
      <div class="price">
        <h3>Starter PKS</h3>
        <div style="font-size:.82rem;color:var(--dim);margin:4px 0 16px">Untuk PKS Skala Kecil / Mandiri (&lt; 30 Ton/Jam)</div>
        <div class="amount">Rp 15jt <small>/setup</small></div>
        <div class="monthly">Langganan cloud: <b>Rp 1,5jt/bln</b></div>
        <ul>
        ...
        <a href="https://wa.me/6281399997132?text=Halo%20MBS%2C%20saya%20tertarik%20Paket%20Starter%20PKS" target="_blank" class="btn btn-ghost">Pilih Starter</a>
      </div>

      <div class="price popular">
        <div class="badge-pop">PALING BANYAK DIPILIH</div>
        <h3>Professional PKS</h3>
        <div style="font-size:.82rem;color:var(--dim);margin:4px 0 16px">Untuk PKS Komersial &amp; Kemitraan (30–60 Ton/Jam)</div>
        <div class="amount" style="color:var(--accent)">Rp 25jt <small>/setup</small></div>
        <div class="monthly">Langganan cloud: <b>Rp 2,5jt/bln</b></div>
        <ul>
          <li>Multi-Jembatan Timbang (Timbang Masuk &amp; Keluar)</li>
          <li>Modul Digital Sortasi &amp; Rumus Potongan TBS</li>
          <li>Dashboard Rendemen Real-time (OER &amp; KER)</li>
          <li>Notifikasi Otomatis WhatsApp ke Supplier</li>
          <li>Dispatch Truk Tangki CPO &amp; Surat Jalan QR</li>
          <li>Portal Akses Supplier &amp; Koperasi Kebun</li>
        </ul>
        <a href="https://wa.me/6281399997132?text=Halo%20MBS%2C%20saya%20tertarik%20Paket%20Professional%20PKS" target="_blank" class="btn btn-primary">Pilih Professional</a>
      </div>

      <div class="price">
        <h3>Enterprise PKS</h3>
        <div style="font-size:.82rem;color:var(--dim);margin:4px 0 16px">Untuk Grup Perkebunan &amp; Pabrik Ekspor CPO (&gt; 60 Ton/Jam)</div>
        <div class="amount">Rp 45jt <small>/setup</small></div>
        <div class="monthly">Langganan cloud: <b>Rp 4,5jt/bln</b></div>
        <ul>
          <li>Semua Fitur Paket Professional</li>
          <li>EUDR &amp; ISPO Geolocation Traceability Module</li>
          <li>Modul Maintenance &amp; Sparepart Mesin Pabrik</li>
          <li>Accounting &amp; General Ledger Integrasi PKS</li>
          <li>Offline-First Hybrid Sync (Anti Runtuh Internet)</li>
          <li>Custom Development &amp; On-Site Training</li>
        </ul>
        <a href="https://wa.me/6281399997132?text=Halo%20MBS%2C%20saya%20tertarik%20Paket%20Enterprise%20PKS" target="_blank" class="btn btn-ghost">Pilih Enterprise</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px">
      <div style="display:flex;align-items:center;gap:12px">
        <img src="/images/brand/mbs-symbol-160.png" alt="MBS" width="44" height="33">
        <div>
          <b style="color:var(--text)">Mora Bangun Solutions</b>
          <div style="font-size:.7rem;color:var(--dim)">SPESIALIS ERP &amp; DIGITALISASI PABRUK KELAPA SAWIT</div>
        </div>
      </div>
      <div style="font-size:.8rem;color:var(--dim)">
        © 2026 Mora Bangun Solutions · Medan, Sumatera Utara, Indonesia
      </div>
    </div>
  </div>
</footer>

<a class="fab-wa" href="https://wa.me/6281399997132?text=Halo%20MBS%2C%20mau%20tanya%20sistem%20Pabrik%20Kelapa%20Sawit" target="_blank" aria-label="WhatsApp">💬</a>
...
function calcPksRoi() {
  ...
  // Estimasi harga TBS Rp 2.500/kg (Rp 2.500.000/ton), pencegahan kebocoran 0.3%
