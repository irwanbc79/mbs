...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .govline{max-width:820px;margin:26px auto 0;background:var(--card);border:1px solid var(--border);border-radius:12px;padding:12px 18px;font-size:.8rem;color:var(--muted);text-align:center}
  .govline b{color:var(--text)}
  .hubwrap{max-width:1000px;margin:0 auto;padding:10px 0 60px;text-align:left}
  .hublabel{display:flex;align-items:center;gap:12px;font-size:.7rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--dim);margin:30px 0 12px}
  .hublabel::after{content:'';flex:1;height:1px;background:var(--border)}
  ...
  .hubcta{margin-top:34px;text-align:center;background:var(--card);border:1px dashed var(--border);border-radius:14px;padding:26px 20px}
  .hubcta b{font-size:1rem}
  .hubcta p{font-size:.82rem;color:var(--muted);margin:6px 0 14px}
  .pill{font-size:.62rem;padding:3px 9px;border-radius:999px;font-weight:650}
  .pill-g{background:rgba(52,211,153,.13);color:var(--green)}
</style>
</head>
<body>
...
<div class="container hubwrap" id="daftar-solusi">
    ...
    <div class="hubcta">
      ...
      <p data-i18n="hubCtaP">Fondasi kami sama — portal, tracking, tagihan, WA otomatis. Ceritakan alur kerja Anda, kami bentuk sistemnya.</p>
      <a class="btn btn-wa" data-i18n="hubCtaBtn" href="https://wa.me/6281399997132?text=Halo%20MBS%2C%20industri%20kami%20belum%20ada%20di%20daftar%20solusi%20%E2%80%94%20mau%20konsultasi" target="_blank" rel="noopener">💬 Konsultasi Gratis 30 Menit</a>
    </div>
</div>
