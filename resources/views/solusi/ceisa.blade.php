...
<header class="hero">
  <div class="container hero-grid">
    ...
    <div class="hero-visual">
      ...
      <div style="text-align:center;color:var(--dim);font-size:.8rem">morabangun.com/solusi/ceisa</div>
    </div>
  </div>
</header>
...
<section>
  <div class="container center">
    ...
    <div class="cards3" style="text-align:left">
      ...
      <div class="pain-card">
        <div class="ico">⚠️</div>
        <h3 data-i18n="ceisa_pain_2_h">Notul & Kargo Tertahan</h3>
        <p data-i18n="ceisa_pain_2_p">HS code atau nilai pabean yang salah berujung notul, denda, bahkan kargo tertahan di pelabuhan.</p>
        <div class="fix" data-i18n="ceisa_pain_2_f">✓ Validasi HS code & kelengkapan sebelum submit</div>
      </div>
    </div>
  </div>
</section>
...
<div class="demo-wrap">
      <div class="demo-toolbar">
        <div>
          <span class="lbl">Simulasi · pilih dokumen contoh, lalu jalankan</span>
        </div>
        <div style="text-align:right"><span class="lbl">PT Mitra Kargo Nusantara · PPJK</span></div>
      </div>
      <div style="padding:18px 20px;text-align:left">
        <div class="docpick">
          <button class="doc-card sel" id="doc-pib" onclick="pickDoc('pib')"><span class="tag">BC 2.0 · IMPOR</span><b>PIB — Sparepart Mesin</b><small>Invoice USD 24.500 · 8708.99.90 · Tanjung Priok</small></button>
          <button class="doc-card" id="doc-peb" onclick="pickDoc('peb')"><span class="tag">BC 3.0 · EKSPOR</span><b>PEB — Kopi Arabika → Jepang</b><small>Invoice USD 42.000 · 0901.11.10 · Belawan</small></button>
        </div>
        <div class="runrow">
        ...
        <div class="roi">
          <span class="lbl">💡 Kalkulator hemat waktu — berapa dokumen PIB/PEB per bulan?</span>
          <input type="range" min="50" max="1000" step="50" value="200" id="roiRange" oninput="roiCalc()">
          <div class="roi-out">
            <div><b id="roiDocs">200</b>dokumen / bulan</div>
            <div><b id="roiJam">53 jam</b>kerja input manual dihemat*</div>
            <div><b id="roiRp">± Rp 2,7jt</b>setara biaya staf / bulan</div>
          </div>
          <div style="font-size:.64rem;color:var(--dim);margin-top:8px">*asumsi 20 menit/dokumen input manual, 80% terotomasi, Rp 32rb/jam biaya staf dokumen</div>
        </div>
      </div>
    </div>
    </div>
...
<section id="fitur" style="background:var(--surface);border-top:1px solid var(--border);border-bottom:1px solid var(--border)">
  <div class="container center">
    ...
    <div class="feat-grid" style="text-align:left">
      <div class="feat">
        <div class="ico">🎨</div>
        <h3 data-i18n="ceisa_feat_0_h">White-Label Penuh</h3>
        <p data-i18n="ceisa_feat_0_p">Logo, warna, dan subdomain milik Anda sendiri. Pengguna melihat brand Anda, bukan kami.</p>
        
      </div>
      <div class="feat">
        <div class="ico">🔍</div>
        <h3 data-i18n="ceisa_feat_1_h">OCR Dokumen Otomatis</h3>
        <p data-i18n="ceisa_feat_1_p">Invoice, packing list, B/L dibaca otomatis — tanpa input manual ganda.</p>
      ...
      <div class="feat">
        <div class="ico">💬</div>
        <h3 data-i18n="ceisa_feat_3_h">Notifikasi WhatsApp Otomatis</h3>
        <p data-i18n="ceisa_feat_3_p">Status berubah → pengguna dapat WA otomatis. Tanpa staf kirim manual satu-satu.</p>
      ...
      <div class="feat">
        <div class="ico">👥</div>
        <h3 data-i18n="ceisa_feat_5_h">Multi-User & Role</h3>
        <p data-i18n="ceisa_feat_5_p">Admin, staf operasional, keuangan — login terpisah per peran. Audit log lengkap.</p>
        
      </div>
      <div class="feat">
        <div class="ico">🏢</div>
        <h3 data-i18n="ceisa_feat_6_h">Multi-Perusahaan</h3>
        <p data-i18n="ceisa_feat_6_p">Untuk PPJK yang memegang banyak klien — kelola semua dari satu portal.</p>
        
      </div>
      <div class="feat">
        <div class="ico">🌐</div>
        <h3 data-i18n="ceisa_feat_7_h">Multi-Bahasa (ID/EN)</h3>
        <p data-i18n="ceisa_feat_7_p">Portal tersedia dwibahasa — siap dipakai pengguna asing/mitra luar negeri Anda.</p>
...
<section class="final">
  <div class="container">
    ...
    <a class="btn btn-wa" style="font-size:1.05rem;padding:16px 36px" data-wa data-pkg="CEISA H2H — PPJK & Ekspor-Impor" data-pos="final" href="https://wa.me/6281399997132" target="_blank" rel="noopener" data-i18n="finCta">💬 Jadwalkan Demo via WhatsApp</a>
...
<a class="fab-wa" data-wa data-pkg="CEISA H2H — PPJK & Ekspor-Impor" data-pos="fab" href="https://wa.me/6281399997132" target="_blank" rel="noopener" aria-label="WhatsApp">💬</a>

<script>
  var tenantName = 'PT Mitra Kargo Nusantara';
  ...
  function pickDoc(d){
    docSel=d;
    document.getElementById('doc-pib').classList.toggle('sel',d==='pib');
    document.getElementById('doc-peb').classList.toggle('sel',d==='peb');
    resetPipe();
  }
  function steps(){
    var pib = docSel==='pib';
  ...
  function runPipe(){
    resetPipe();
    var log=document.getElementById('plog'); log.innerHTML='';
    document.getElementById('runBtn').disabled=true;
    steps().forEach(function(s,i,arr){
      pipeTimers.push(setTimeout(function(){
        ...
        log.appendChild(r);
        if(i===arr.length-1) document.getElementById('runBtn').disabled=false;
      }, 650*(i+1)));
    });
  }
  function resetPipe(){
    ...
    document.getElementById('plog').innerHTML='<div class="plog-empty">Log proses akan tampil di sini — klik <b style="color:var(--ceisa)">Jalankan Proses</b>.</div>';
  }
  function roiCalc(){
    var docs=+document.getElementById('roiRange').value;
    var jam=Math.round(docs*20/60*0.8);
    var rp=jam*32000;
    document.getElementById('roiDocs').textContent=docs;
    document.getElementById('roiJam').textContent=jam+' jam';
    document.getElementById('roiRp').textContent='± Rp '+(rp>=1000000?(rp/1000000).toFixed(1).replace('.',',')+'jt':Math.round(rp/1000)+'rb');
  }
  ...
  var EN = {
    ...
    'ceisa_pain_0_h': 'Manual Entry, Error-Prone',
    'ceisa_pain_0_p': 'Staff retype data from invoice/PL into the CEISA portal. One typo in HS code or customs value risks a fine.',
    ...
    'ceisa_feat_0_h': 'Full White-Label',
    ...
    'ceisa_pr_Starter_i2': 'White-label logo & colors',
    'ceisa_pr_Starter_i3': 'Unlimited staff logins',
    'ceisa_pr_Starter_i4': 'Document volume reports',
    'ceisa_pr_Starter_n0': 'Automatic OCR & H2H submission',
    'ceisa_pr_Starter_n1': 'Automatic WA notifications',
    'ceisa_pr_Starter_cta': 'Choose Starter',
    ...
    'ceisa_pr_Enterprise_i3': 'Dedicated server + uptime SLA',
    'ceisa_pr_Enterprise_i4': 'Custom modules for your workflow',
    ...
    'ceisa_fq0': 'Our operational data is already in Excel. Do we re-enter everything?',
    'ceisa_fa0': 'No. The Professional plan includes importing your existing Excel data. Your team just updates statuses — or we integrate with the system you already run.',
    'ceisa_fq1': 'Do our users have to pay or install an app?',
