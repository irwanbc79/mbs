        ...
        <div class="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="scroll-reveal glass-card p-6 space-y-5">
                    ...
                    <!-- WhatsApp -->
                    <a href="https://wa.me/?text=Halo%20Mora%20Bangun%20Solutions%2C%20saya%20tertarik%20dengan%20layanan%20Anda" target="_blank" rel="noopener noreferrer" data-testid="contact-whatsapp" class="flex items-center gap-4 group">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-white group-hover:text-green-400 transition-colors font-medium">+62 812-XXXX-XXXX</p>
                            <p class="text-[10px] text-slate-600 mt-0.5">Segera tersedia</p>
                        </div>
                    </a>
