        ...
        <div class="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="scroll-reveal glass-card p-6 space-y-5">
                    ...
                    <!-- WhatsApp -->
                    <a href="https://wa.me/6281266686678?text=Halo%20Mora%20Bangun%20Solutions%2C%20saya%20tertarik%20dengan%20layanan%20Anda" target="_blank" class="flex items-center gap-4 group">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-white group-hover:text-green-400 transition-colors font-medium">+62 812-6668-6678</p>
                        </div>
                    </a>
                        ...
                        <div class="mb-4">
                            ...
                            <select x-model="form.industry"
                                ...
                                <option value="" disabled selected>
                                    <span x-show="$store.locale === 'id'">Pilih skala perusahaan Anda</span>
                                </option>
                                <option value="korporasi">
                                    <span x-show="$store.locale === 'id'">Korporasi (Perusahaan Besar)</span>
                                    <span x-show="$store.locale === 'en'" x-cloak>Corporation (Large Enterprise)</span>
                                </option>
                                <option value="bumn">BUMN / BUMD</option>
                                <option value="startup">Startup &amp; Scale-up</option>
                                <option value="ukm">
                                    <span x-show="$store.locale === 'id'">UKM / UMKM</span>
                                    <span x-show="$store.locale === 'en'" x-cloak>SME</span>
                                </option>
                                <option value="lainnya">
                                    <span x-show="$store.locale === 'id'">Lainnya</span>
                                    <span x-show="$store.locale === 'en'" x-cloak>Other</span>
                                </option>
                            </select>
                        </div>
