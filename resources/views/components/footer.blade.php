        ...
        <div class="grid md:grid-cols-12 gap-10 mb-12">
            ...
            <div class="md:col-span-4">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="https://wa.me/6281266686678" target="_blank" class="w-9 h-9 rounded-lg border border-slate-800 hover:border-green-500/40 flex items-center justify-center text-slate-500 hover:text-green-400 transition-all">
