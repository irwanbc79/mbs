        ...
        <div class="grid md:grid-cols-12 gap-10 mb-12">
            ...
            <div class="md:col-span-4">
                <div class="flex items-center gap-3 mb-5">
                    <div class="h-12 w-12 relative overflow-hidden flex-shrink-0" style="filter:drop-shadow(0 0 10px rgba(34,211,238,0.35))">
                        {{-- PNG logo: crop to hex mark only --}}
                        <img src="{{ asset('images/mbs-logo.png') }}"
                             alt="MBS"
                             style="position:absolute; width:auto; height:79px; top:0; left:50%; transform:translateX(-50%);"
            ...
            <div class="md:col-span-4">
                ...
                <ul class="space-y-4">
                    ...
                    <li>
                        <a href="https://wa.me/6281399997132" target="_blank" class="flex items-center gap-3 group">
                            ...
                            <span class="text-sm text-slate-500 group-hover:text-white transition-colors font-body">+62 813-9999-7132</span>
                        </a>
                    </li>
