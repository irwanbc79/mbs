<section id="portfolio" class="section-padding relative bg-[#050d1e]">
    ...
    <div class="container-max">
        ...
        <!-- Film Strip Marquee (Horizontal Infinite Scroll) -->
        <div class="scroll-reveal relative w-full overflow-hidden my-8 select-none">
            <!-- Left & Right Vignette Shadow Overlays -->
            <div class="absolute left-0 top-0 bottom-0 w-16 md:w-32 bg-gradient-to-r from-[#050d1e] to-transparent z-20 pointer-events-none"></div>
            <div class="absolute right-0 top-0 bottom-0 w-16 md:w-32 bg-gradient-to-l from-[#050d1e] to-transparent z-20 pointer-events-none"></div>

            <!-- Sprocket Track Top -->
            <div class="film-track-top"></div>

            <!-- Marquee Inner Container (Pauses on Hover) -->
            <div class="marquee-inner py-6">
                
                <!-- Set 1: Original Cards -->
                <div class="flex gap-6 shrink-0 film-strip-track px-3">
                    
                    <!-- 1: m2b.co.id -->
                    <a href="https://m2b.co.id" target="_blank" rel="noopener noreferrer"
                       data-testid="portfolio-m2b"
                       class="group block browser-frame hover:border-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                    ...
                    <a href="https://portal.m2b.co.id" target="_blank" rel="noopener noreferrer"
                       ...
                       class="group block browser-frame hover:border-violet-500/30 hover:shadow-xl hover:shadow-violet-500/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                        <div class="browser-topbar">
                            <span class="browser-dot bg-[#FF5F57]"></span>
                            <span class="browser-dot bg-[#FFBD2E]"></span>
                            <span class="browser-dot bg-[#28CA41]"></span>
                    ...
                    <a href="https://dira.co.id" target="_blank" rel="noopener noreferrer"
                       ...
                       class="group block browser-frame hover:border-amber-500/30 hover:shadow-xl hover:shadow-amber-500/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                        <div class="browser-topbar">
                            <span class="browser-dot bg-[#FF5F57]"></span>
                            <span class="browser-dot bg-[#FFBD2E]"></span>
                            <span class="browser-dot bg-[#28CA41]"></span>
                    ...
                    <a href="https://indoplas.co.id" target="_blank" rel="noopener noreferrer"
                       ...
                       class="group block browser-frame hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                        <div class="browser-topbar">
                            <span class="browser-dot bg-[#FF5F57]"></span>
                            <span class="browser-dot bg-[#FFBD2E]"></span>
                            <span class="browser-dot bg-[#28CA41]"></span>
                    ...
                    <a href="https://gma-world.id" target="_blank" rel="noopener noreferrer"
                       ...
                       class="group block browser-frame hover:border-sky-500/30 hover:shadow-xl hover:shadow-sky-500/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                        <div class="browser-topbar">
                            <span class="browser-dot bg-[#FF5F57]"></span>
                            <span class="browser-dot bg-[#FFBD2E]"></span>
                            <span class="browser-dot bg-[#28CA41]"></span>
                    ...
                    <a href="https://ladaik.store" target="_blank" rel="noopener noreferrer"
                       ...
                       class="group block browser-frame hover:border-rose-500/30 hover:shadow-xl hover:shadow-rose-500/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                        <div class="browser-topbar">
                            <span class="browser-dot bg-[#FF5F57]"></span>
                            <span class="browser-dot bg-[#FFBD2E]"></span>
                            <span class="browser-dot bg-[#28CA41]"></span>
                    ...
                    <!-- 7: indoessentialoil.com -->
                    <a href="https://indoessentialoil.com" target="_blank" rel="noopener noreferrer"
                       data-testid="portfolio-indoessentialoil"
                       class="group block browser-frame hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                        <div class="browser-topbar">
                            <span class="browser-dot bg-[#FF5F57]"></span>
                            <span class="browser-dot bg-[#FFBD2E]"></span>
                            <span class="browser-dot bg-[#28CA41]"></span>
                            <div class="browser-url">https://indoessentialoil.com</div>
                            <span class="text-[9px] text-emerald-400 font-medium">LIVE</span>
                        </div>
                        <div class="relative overflow-hidden" style="aspect-ratio: 16/9;">
                            <img src="{{ asset('images/portfolio/indoessentialoil.jpg') }}"
                                 alt="IndoEssentialOil"
                                 class="absolute inset-0 w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105 z-10"
                                 onerror="this.style.display='none'"
                                 loading="lazy">
                            <div class="absolute inset-0 bg-gradient-to-br from-[#1c2717] via-[#2f4a35] to-[#0f170a] flex flex-col group-hover:scale-105 transition-transform duration-500 overflow-hidden">
                                <div class="flex items-center px-3 bg-[#243727]/60 border-b border-[#3e5f43]/20 shrink-0" style="height:24px">
                                    <div class="w-12 h-2 bg-[#f4f1e9]/40 rounded mr-auto"></div>
                                    <div class="flex gap-1.5 items-center">
                                        <div class="w-4 h-1 bg-[#f4f1e9]/15 rounded"></div>
                                        <div class="w-4 h-1 bg-[#f4f1e9]/15 rounded"></div>
                                        <div class="w-10 h-3.5 bg-[#b8923a]/30 rounded border border-[#b8923a]/30 flex items-center justify-center text-[5px] text-[#f4f1e9]/80 font-bold font-mono">EN</div>
                                    </div>
                                </div>
                                <div class="flex flex-col grow justify-center px-4 relative">
                                    <div class="absolute top-2 right-4 w-12 h-12 bg-gradient-to-br from-[#b8923a]/20 to-transparent rounded-full blur-sm"></div>
                                    <div class="w-16 h-2 bg-[#b8923a]/45 rounded mb-1.5"></div>
                                    <div class="w-28 h-3.5 bg-[#f4f1e9]/70 rounded mb-1"></div>
                                    <div class="w-32 h-1.5 bg-[#f4f1e9]/35 rounded mb-0.5"></div>
                                    <div class="w-24 h-1.5 bg-[#f4f1e9]/20 rounded mb-3"></div>
                                    <div class="flex gap-2">
                                        <div class="w-12 h-4 bg-[#2f4a35] border border-[#3e5f43]/40 rounded shadow-md"></div>
                                        <div class="w-12 h-4 bg-transparent border border-[#f4f1e9]/20 rounded"></div>
                                    </div>
                                </div>
                                <div class="flex items-center justify-between px-3 shrink-0 bg-[#0f170a]/60 border-t border-[#3e5f43]/15" style="height:22px">
                                    <div class="w-16 h-1 bg-[#f4f1e9]/20 rounded"></div>
                                    <div class="w-6 h-2 bg-[#b8923a]/40 rounded"></div>
                                </div>
                            </div>
                        </div>
                        <div class="p-5">
                            <div class="flex items-start justify-between mb-2">
                                <h3 class="font-bold text-white group-hover:text-emerald-400 transition-colors">IndoEssentialOil</h3>
                                <svg class="w-4 h-4 text-slate-600 group-hover:text-emerald-400 transition-colors flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                            </div>
                            <p class="text-xs text-slate-500 mb-3 font-body">
                                <span x-show="$store.locale === 'id'">Landing page premium untuk eksportir minyak nilam Aceh Jaya ke pasar global.</span>
                                <span x-show="$store.locale === 'en'" x-cloak>Premium landing page for Aceh Jaya patchouli oil exporter to the global market.</span>
                            </p>
                            <div class="flex flex-wrap gap-1.5">
                                <span class="text-xs px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">Landing Page</span>
                                <span class="text-xs px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">Bilingual</span>
                                <span class="text-xs px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">SEO</span>
                            </div>
                        </div>
                    </a>
                    ...
                    <!-- 8: ceisa.m2b.co.id -->
                    <a href="https://ceisa.m2b.co.id" target="_blank" rel="noopener noreferrer"
                       data-testid="portfolio-ceisa"
                       class="group block browser-frame hover:border-[#C9A55C]/40 hover:shadow-xl hover:shadow-[#C9A55C]/5 transition-all duration-300 hover:-translate-y-1 w-[320px] sm:w-[360px] shrink-0">
                        <div class="browser-topbar">
                            <span class="browser-dot bg-[#FF5F57]"></span>
                            <span class="browser-dot bg-[#FFBD2E]"></span>
                            <span class="browser-dot bg-[#28CA41]"></span>
                        ...
                        <div class="relative overflow-hidden" style="aspect-ratio: 16/9;">
                            <img src="{{ asset('images/portfolio/ceisa.jpg') }}"
                                 alt="M2B Customs CEISA"
                                 class="absolute inset-0 w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105 z-10"
                                 onerror="this.style.display='none'"
                                 loading="lazy">
                            <div class="absolute inset-0 bg-[#0B1437] flex group-hover:scale-105 transition-transform duration-500 overflow-hidden">
                                <!-- Sidebar -->
                                <div class="flex flex-col items-center pt-3 gap-2 shrink-0 bg-[#080d26] border-r border-[#C9A55C]/15" style="width:38px">
                                    <div class="w-4.5 h-4.5 rounded bg-[#C9A55C]/35 border border-[#C9A55C]/30 flex items-center justify-center text-[6px] text-white">⚙️</div>
                                    <div class="w-4.5 h-4.5 rounded bg-[#0E867E]/40 border border-[#0E867E]/30"></div>
                                    <div class="w-4.5 h-4.5 rounded bg-white/5 border border-white/10"></div>
                                    <div class="w-4.5 h-4.5 rounded bg-white/5 border border-white/10"></div>
                                    <div class="mt-auto mb-2.5 w-4.5 h-4.5 rounded-full bg-[#C9A55C]/20 border border-[#C9A55C]/20"></div>
                                </div>
                                <!-- Main Panel -->
                                <div class="flex flex-col flex-1 p-2 gap-2 min-w-0">
                                    <!-- Nav header -->
                                    <div class="flex items-center justify-between border-b border-white/5 pb-1">
                                        <div class="flex items-center gap-1">
                                            <div class="w-2.5 h-2.5 bg-[#C9A55C] rounded-full"></div>
                                            <div class="w-16 h-2 bg-white/40 rounded"></div>
                                        </div>
                                        <div class="w-10 h-3 bg-[#0E867E]/30 rounded border border-[#0E867E]/25"></div>
                                    </div>
                                    <!-- Dashboard Info -->
                        ...
                        <div class="p-5">
                            <div class="flex items-start justify-between mb-2">
                                <h3 class="font-bold text-white group-hover:text-[#C9A55C] transition-colors">M2B Customs CEISA</h3>
                ...
                <div class="flex gap-6 shrink-0 film-strip-track px-3" aria-hidden="true">
            ...
            <!-- Sprocket Track Bottom -->
            <div class="film-track-bottom"></div>
        </div>
